...
##### 2.1.3 Empty progress column --> Warn user and keep Value column
...
##### 6.1.2 Qualitative indicator with CAGR = 0.5%, score should be 0
##### 6.1.3 Qualitative indicator with CAGR = 0%, score should be -2.5
##### 6.1.4 Qualitative indicator with CAGR = -1%, score should be -3.75
##### 6.2.1 Qualitative indicator near limit with CAGR/coeff = 1.5%, score should be 2.5
##### 6.2.2 Qualitative indicator near limit with CAGR/coeff = 0.5%, score should be 0
##### 6.2.3 Qualitative indicator near limit with CAGR/coeff = 0%, score should be -2.5
##### 6.2.4 Qualitative indicator near limit with CAGR/coeff = -1%, score should be -3.75
